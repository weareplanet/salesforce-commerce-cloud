...
exports.CountryStateService = void 0;
/* global dw empty */
...
var CountryStateService = /** @class */ (function () {
    function CountryStateService(httpService) {
    ...
    */
    CountryStateService.prototype.all = function (options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            if (ObjectSerializer.primitives.indexOf("Array<RestCountryState>".toLowerCase()) !== -1) {
                return body;
            }
            try {
                ...
                dw.system.Logger.error("weareplanet > CountryStateService > all > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > CountryStateService > all > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    * This operation returns all states for a given country.
    * @summary Find by Country
    * @param { string } code code The country code in ISO code two letter format for which all states should be returned.
    * @param {*} [options] Override http request options.
    * @return {  Array<RestCountryState>  }
    */
    CountryStateService.prototype.country = function (code, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > CountryStateService > country > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > CountryStateService > country > " + error.type + " > " + JSON.stringify(error));
        }
    };
    return CountryStateService;
}());
exports.CountryStateService = CountryStateService;
module.exports = CountryStateService;
