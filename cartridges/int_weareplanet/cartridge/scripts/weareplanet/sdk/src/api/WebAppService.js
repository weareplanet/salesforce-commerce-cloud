...
var WebAppService = /** @class */ (function () {
    function WebAppService(httpService) {
    ...
    * @param { number } spaceId spaceId This parameter identifies the space which should be checked if the web app is installed.
    * @param {*} [options] Override http request options.
    * @return {  boolean  }
    */
    WebAppService.prototype.checkInstallation = function (spaceId, options) {
        ...
        var localVarRequestOptions = {
            ...
            url: this.basePath,
            path: "/web-app/check-installation",
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > WebAppService > checkInstallation > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > WebAppService > checkInstallation > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Confirm
    * @param { WebAppConfirmationRequest } request request
    * @param {*} [options] Override http request options.
    * @return {  WebAppConfirmationResponse  }
    */
    WebAppService.prototype.confirm = function (request, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            url: this.basePath,
            path: "/web-app/confirm",
            contentType: "application/json",
            body: JSON.stringify(ObjectSerializer.serialize(request, "WebAppConfirmationRequest")),
            form: {},
            formData: {}
        };
        if (Object.keys(localVarFormParams).length) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("WebAppConfirmationResponse".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > WebAppService > confirm > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > WebAppService > confirm > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Uninstall
    * @param { number } spaceId spaceId This parameter identifies the space within which the web app should be uninstalled.
    * @param {*} [options] Override http request options.
    * @return {  any  }
    */
    WebAppService.prototype.uninstall = function (spaceId, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > WebAppService > uninstall > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > WebAppService > uninstall > " + error.type + " > " + JSON.stringify(error));
        }
    };
