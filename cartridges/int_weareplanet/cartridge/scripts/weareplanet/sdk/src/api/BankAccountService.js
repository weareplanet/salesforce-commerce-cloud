...
var BankAccountService = /** @class */ (function () {
    function BankAccountService(httpService) {
    ...
    * @return {  number  }
    */
    BankAccountService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > BankAccountService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > BankAccountService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Read
    * @param { number } spaceId spaceId
    * @param { number } id id The ID of the bank account which should be returned.
    * @param {*} [options] Override http request options.
    * @return {  BankAccount  }
    */
    BankAccountService.prototype.read = function (spaceId, id, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("BankAccount".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > BankAccountService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > BankAccountService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Search
    * @param { number } spaceId spaceId
    * @param { EntityQuery } query query The query restricts the bank accounts which are returned by the search.
    * @param {*} [options] Override http request options.
    * @return {  Array<BankAccount>  }
    */
    BankAccountService.prototype.search = function (spaceId, query, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("Array<BankAccount>".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > BankAccountService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > BankAccountService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
