...
exports.TransactionCommentService = void 0;
/* global dw empty */
...
var TransactionCommentService = /** @class */ (function () {
    ...
    * @summary Create
    * @param { number } spaceId spaceId
    * @param { TransactionCommentCreate } entity entity The comment object which should be created.
    * @param {*} [options] Override http request options.
    ...
    * @summary Update
    * @param { number } spaceId spaceId
    * @param { TransactionCommentActive } entity entity The comment object with the properties which should be updated.
    * @param {*} [options] Override http request options.
    * @return {  TransactionComment  }
    */
