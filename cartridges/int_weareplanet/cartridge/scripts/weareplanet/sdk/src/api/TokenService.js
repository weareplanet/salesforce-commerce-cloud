...
var TokenService = /** @class */ (function () {
    ...
    * @return {  any  }
    */
    TokenService.prototype._delete = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > _delete > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > _delete > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TokenService.prototype.checkTokenCreationPossible = function (spaceId, transactionId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > checkTokenCreationPossible > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > checkTokenCreationPossible > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @return {  number  }
    */
    TokenService.prototype.count = function (spaceId, filter, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Create
    * @param { number } spaceId spaceId
    * @param { TokenCreate } entity entity The token object with the properties which should be created.
    * @param {*} [options] Override http request options.
    * @return {  Token  }
    */
    TokenService.prototype.create = function (spaceId, entity, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("Token".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > TokenService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @return {  Token  }
    */
    TokenService.prototype.createToken = function (spaceId, transactionId, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > createToken > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > createToken > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TokenService.prototype.createTokenBasedOnTransaction = function (spaceId, transactionId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > createTokenBasedOnTransaction > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > createTokenBasedOnTransaction > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @param { number } spaceId spaceId
    * @param { number } tokenId tokenId The id of the token which should be updated.
    * @param {*} [options] Override http request options.
    * @return {  Transaction  }
    */
    TokenService.prototype.createTransactionForTokenUpdate = function (spaceId, tokenId, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > createTransactionForTokenUpdate > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > createTransactionForTokenUpdate > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TokenService.prototype.processTransaction = function (spaceId, transactionId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > processTransaction > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > processTransaction > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Read
    * @param { number } spaceId spaceId
    * @param { number } id id The id of the token which should be returned.
    * @param {*} [options] Override http request options.
    * @return {  Token  }
    */
    TokenService.prototype.read = function (spaceId, id, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Search
    * @param { number } spaceId spaceId
    * @param { EntityQuery } query query The query restricts the tokens which are returned by the search.
    * @param {*} [options] Override http request options.
    * @return {  Array<Token>  }
    */
    TokenService.prototype.search = function (spaceId, query, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("Array<Token>".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > TokenService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    * @summary Update
    * @param { number } spaceId spaceId
    * @param { TokenUpdate } entity entity The object with all the properties which should be updated. The id and the version are required properties.
    * @param {*} [options] Override http request options.
    * @return {  Token  }
    */
    TokenService.prototype.update = function (spaceId, entity, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > TokenService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > TokenService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
    return TokenService;
}());
