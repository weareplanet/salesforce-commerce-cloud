...
exports.SubscriptionVersionService = void 0;
/* global dw empty */
...
var SubscriptionVersionService = /** @class */ (function () {
    function SubscriptionVersionService(httpService) {
    ...
    * @return {  number  }
    */
    SubscriptionVersionService.prototype.count = function (spaceId, filter, options) {
        ...
        var localVarRequestOptions = {
            ...
            url: this.basePath,
            path: "/subscription-version/count",
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > SubscriptionVersionService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > SubscriptionVersionService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    */
    SubscriptionVersionService.prototype.read = function (spaceId, id, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            url: this.basePath,
            path: "/subscription-version/read",
            contentType: "application/json",
            form: {},
            formData: {}
        };
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("weareplanet > SubscriptionVersionService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > SubscriptionVersionService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    */
    SubscriptionVersionService.prototype.search = function (spaceId, query, options) {
        if (options === void 0) { options = {}; }
        var localVarQueryParameters = {};
        var localVarHeaderParams = {};
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            url: this.basePath,
            path: "/subscription-version/search",
            contentType: "application/json",
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            var body = response.text;
            if (ObjectSerializer.primitives.indexOf("Array<SubscriptionVersion>".toLowerCase()) !== -1) {
                return body;
            }
            try {
                body = JSON.parse(body);
                ...
                dw.system.Logger.error("weareplanet > SubscriptionVersionService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("weareplanet > SubscriptionVersionService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    return SubscriptionVersionService;
}());
exports.SubscriptionVersionService = SubscriptionVersionService;
module.exports = SubscriptionVersionService;
