...
var ChargeFlowLevelPaymentLink = /** @class */ (function (_super) {
    __extends(ChargeFlowLevelPaymentLink, _super);
    function ChargeFlowLevelPaymentLink() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ChargeFlowLevelPaymentLink.getAttributeTypeMap = function () {
        return _super.getAttributeTypeMap.call(this).concat(ChargeFlowLevelPaymentLink.attributeTypeMap);
    };
