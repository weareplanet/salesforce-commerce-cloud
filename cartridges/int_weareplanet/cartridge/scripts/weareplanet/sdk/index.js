...
var WeArePlanetModule = {
    model: {
        ...
        BillingConfiguration: require("./src/models/BillingConfiguration"),
        BillingCycleModel: require("./src/models/BillingCycleModel"),
        BillingCycleType: require("./src/models/BillingCycleType"),
        BillingDayCustomization: require("./src/models/BillingDayCustomization"),
        ...
        DisplayableDayOfWeek: require("./src/models/DisplayableDayOfWeek"),
        DisplayableMonth: require("./src/models/DisplayableMonth"),
        ...
        DunningCase: require("./src/models/DunningCase"),
        DunningCaseLevel: require("./src/models/DunningCaseLevel"),
        DunningCaseLevelState: require("./src/models/DunningCaseLevelState"),
        DunningCaseState: require("./src/models/DunningCaseState"),
        DunningCondition: require("./src/models/DunningCondition"),
        DunningConditionType: require("./src/models/DunningConditionType"),
        DunningFlow: require("./src/models/DunningFlow"),
        DunningFlowLevel: require("./src/models/DunningFlowLevel"),
        DunningFlowLevelProcessor: require("./src/models/DunningFlowLevelProcessor"),
        DunningFlowType: require("./src/models/DunningFlowType"),
        ...
        PanType: require("./src/models/PanType"),
        ...
        PaymentTerminalTransactionSummaryReference: require("./src/models/PaymentTerminalTransactionSummaryReference"),
        ...
        ShopifyV1Integration: require("./src/models/ShopifyV1Integration"),
        ...
        TaxLine: require("./src/models/TaxLine"),
        ...
        TokenVersionRetryStrategy: require("./src/models/TokenVersionRetryStrategy"),
        ...
        WebhookEncryptionPublicKey: require("./src/models/WebhookEncryptionPublicKey"),
    ...
    api: {
        ...
        DunningCaseLevelService: require("./src/api/DunningCaseLevelService"),
        DunningCaseService: require("./src/api/DunningCaseService"),
        DunningFlowLevelService: require("./src/api/DunningFlowLevelService"),
        DunningFlowService: require("./src/api/DunningFlowService"),
        ...
        WebhookEncryptionService: require("./src/api/WebhookEncryptionService"),
